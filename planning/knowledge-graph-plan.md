...
scripts/lib/render-graph-data.mjs
docs/assets/knowledge-graph/graph.js
```
...
The current `data/site-map.json` can remain a small entrance map for now.
...
- `data/zhihu-articles.json`
- `data/zhihu-categories.json`
- `data/zhihu-series.json`
- `data/github-projects.json`
- future `data/gallery.json`
