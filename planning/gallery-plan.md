...
- `docs/assets/gallery/thumbs/`
- `docs/assets/gallery/display/`
- Keep originals outside the public repository unless explicitly approved.

## Data Model

Future file: `data/gallery.json`.
...
1. Add `data/gallery.json`.
2. Add gallery validation.
3. Add `scripts/lib/render-gallery.mjs`.
4. Add `templates/pages/gallery.mjs`.
5. Generate `docs/gallery.html`.
6. Update shared navigation and homepage route cards.
7. Add gallery CSS to `docs/assets/site.css`.
8. Document storage, EXIF, and metadata maintenance in `docs/README.md`.
