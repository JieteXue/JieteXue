...
const siteMapPath = "data/site-map.json";
...
writeText("docs/index.html", renderIndexPage(profile, siteMap));
writeText(
  "docs/zhihu.html",
  renderZhihuPage({
...
writeText("docs/github.html", renderGithubPage({ projects: renderProjects(projects) }));
